                            ...
                            <div class="col-12 col-lg-7 border-end-lg">
                              <div class="py-6">
                                ...
                                <div class="mb-3">
                                  ...
                                  <div class="mt-3">
                                    <label class="btn btn-link p-0" for="customFile-undefined"><span class="fas fa-plus me-1"></span>Add file(s)</label>
                                    <input class="d-none" type="file" id="customFile-undefined" />
                                  </div>
                                </div>
                              </div>
                            </div>
